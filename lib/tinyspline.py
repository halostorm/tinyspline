...
def ts_bspline_bisect(spline: 'tsBSpline const *', value: 'tsReal', epsilon: 'tsReal', persnickety: 'int', index: 'size_t', ascending: 'int', max_iter: 'size_t', net: 'tsDeBoorNet *', status: 'tsStatus *') -> "tsError":
    return _tinysplinepython.ts_bspline_bisect(spline, value, epsilon, persnickety, index, ascending, max_iter, net, status)
...
BSpline.bisect = new_instancemethod(_tinysplinepython.BSpline_bisect, None, BSpline)
