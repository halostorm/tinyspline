...
##	 /usr/local/bin/swig -r -O -outdir /home/travis/build/msteinbeck/tinyspline/tools/ci/build/src/r -c++ -I/home/travis/build/msteinbeck/tinyspline/src -I/usr/lib/jvm/java-8-openjdk-amd64/include -I/usr/lib/jvm/java-8-openjdk-amd64/include/linux -I/usr/include/lua5.3 -I/usr/include/octave-4.0.0/octave -I/usr/include/octave-4.0.0 -I/usr/include/python3.5m -I/usr/share/R/include -I/usr/lib/R/site-library/Rcpp/include -o /home/travis/build/msteinbeck/tinyspline/tools/ci/build/src/r/tinysplinerR_wrap.cxx /home/travis/build/msteinbeck/tinyspline/src/tinyspliner.i
...
# Start of ts_bspline_bisect

`ts_bspline_bisect` = function(spline, value, epsilon, persnickety, index, ascending, max_iter, net, status, .copy = FALSE)
{
  if (inherits(spline, "ExternalReference")) spline = slot(spline,"ref") 
  
  
  persnickety = as.integer(persnickety);
  
  if(length(persnickety) > 1) {
    warning("using only the first element of persnickety");
  };
  ...
  if(length(ascending) > 1) {
    warning("using only the first element of ascending");
  };
  ...
  if (inherits(net, "ExternalReference")) net = slot(net,"ref") 
  if (inherits(status, "ExternalReference")) status = slot(status,"ref") 
  ;ans = .Call('R_swig_ts_bspline_bisect', spline, value, epsilon, persnickety, index, ascending, max_iter, net, status, as.logical(.copy), PACKAGE='tinyspliner');
  ans = enumFromInteger(ans, "_tsError");
...
attr(`ts_bspline_bisect`, 'returnType') = 'character'
attr(`ts_bspline_bisect`, "inputTypes") = c('_p_tsBSpline', 'numeric', 'numeric', 'integer', 'integer', 'integer', 'integer', '_p_tsDeBoorNet', '_p_tsStatus')
class(`ts_bspline_bisect`) = c("SWIGFunction", class('ts_bspline_bisect'))
...
# Start of BSpline_bisect

`BSpline_bisect__SWIG_0` = function(self, value, epsilon, persnickety, index, ascending, maxIter, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  
  
  persnickety = as.logical(persnickety);
  index = as.integer(index);
  ...
  if(length(maxIter) > 1) {
    warning("using only the first element of maxIter");
  };
  
  ;ans = .Call('R_swig_BSpline_bisect__SWIG_0', self, value, epsilon, persnickety, index, ascending, maxIter, as.logical(.copy), PACKAGE='tinyspliner');
  ans <- new("_p_tinyspline__DeBoorNet", ref=ans);
...
attr(`BSpline_bisect__SWIG_0`, 'returnType') = '_p_tinyspline__DeBoorNet'
attr(`BSpline_bisect__SWIG_0`, "inputTypes") = c('_p_tinyspline__BSpline', 'numeric', 'numeric', 'logical', 'integer', 'logical', 'integer')
class(`BSpline_bisect__SWIG_0`) = c("SWIGFunction", class('BSpline_bisect__SWIG_0'))

# Start of BSpline_bisect

`BSpline_bisect__SWIG_1` = function(self, value, epsilon, persnickety, index, ascending, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  ...
  ascending = as.logical(ascending);
  ;ans = .Call('R_swig_BSpline_bisect__SWIG_1', self, value, epsilon, persnickety, index, ascending, as.logical(.copy), PACKAGE='tinyspliner');
  ans <- new("_p_tinyspline__DeBoorNet", ref=ans);
...
attr(`BSpline_bisect__SWIG_1`, 'returnType') = '_p_tinyspline__DeBoorNet'
attr(`BSpline_bisect__SWIG_1`, "inputTypes") = c('_p_tinyspline__BSpline', 'numeric', 'numeric', 'logical', 'integer', 'logical')
class(`BSpline_bisect__SWIG_1`) = c("SWIGFunction", class('BSpline_bisect__SWIG_1'))

# Start of BSpline_bisect

`BSpline_bisect__SWIG_2` = function(self, value, epsilon, persnickety, index, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  ...
  ;ans = .Call('R_swig_BSpline_bisect__SWIG_2', self, value, epsilon, persnickety, index, as.logical(.copy), PACKAGE='tinyspliner');
  ans <- new("_p_tinyspline__DeBoorNet", ref=ans);
...
attr(`BSpline_bisect__SWIG_2`, 'returnType') = '_p_tinyspline__DeBoorNet'
attr(`BSpline_bisect__SWIG_2`, "inputTypes") = c('_p_tinyspline__BSpline', 'numeric', 'numeric', 'logical', 'integer')
class(`BSpline_bisect__SWIG_2`) = c("SWIGFunction", class('BSpline_bisect__SWIG_2'))

# Start of BSpline_bisect

`BSpline_bisect__SWIG_3` = function(self, value, epsilon, persnickety, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  
  
  persnickety = as.logical(persnickety);
  ;ans = .Call('R_swig_BSpline_bisect__SWIG_3', self, value, epsilon, persnickety, as.logical(.copy), PACKAGE='tinyspliner');
  ans <- new("_p_tinyspline__DeBoorNet", ref=ans);
...
attr(`BSpline_bisect__SWIG_3`, 'returnType') = '_p_tinyspline__DeBoorNet'
attr(`BSpline_bisect__SWIG_3`, "inputTypes") = c('_p_tinyspline__BSpline', 'numeric', 'numeric', 'logical')
class(`BSpline_bisect__SWIG_3`) = c("SWIGFunction", class('BSpline_bisect__SWIG_3'))

# Start of BSpline_bisect

`BSpline_bisect__SWIG_4` = function(self, value, epsilon, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  
  
  ;ans = .Call('R_swig_BSpline_bisect__SWIG_4', self, value, epsilon, as.logical(.copy), PACKAGE='tinyspliner');
  ans <- new("_p_tinyspline__DeBoorNet", ref=ans);
...
attr(`BSpline_bisect__SWIG_4`, 'returnType') = '_p_tinyspline__DeBoorNet'
attr(`BSpline_bisect__SWIG_4`, "inputTypes") = c('_p_tinyspline__BSpline', 'numeric', 'numeric')
class(`BSpline_bisect__SWIG_4`) = c("SWIGFunction", class('BSpline_bisect__SWIG_4'))

# Start of BSpline_bisect

`BSpline_bisect__SWIG_5` = function(self, value, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  
  ;ans = .Call('R_swig_BSpline_bisect__SWIG_5', self, value, as.logical(.copy), PACKAGE='tinyspliner');
  ans <- new("_p_tinyspline__DeBoorNet", ref=ans);
...
attr(`BSpline_bisect__SWIG_5`, 'returnType') = '_p_tinyspline__DeBoorNet'
attr(`BSpline_bisect__SWIG_5`, "inputTypes") = c('_p_tinyspline__BSpline', 'numeric')
class(`BSpline_bisect__SWIG_5`) = c("SWIGFunction", class('BSpline_bisect__SWIG_5'))

`BSpline_bisect` <- function(...) {
  argtypes <- mapply(class, list(...));
  argv <- list(...);
  argc <- length(argtypes);
# dispatch functions 6
  if (argc == 2) {
    if (extends(argtypes[1], '_p_tinyspline__BSpline') && ( is.numeric(argv[[2]]) && length(argv[[2]]) == 1 )) {
      f <- BSpline_bisect__SWIG_5; 
    }
  } else if (argc == 3) {
    if (extends(argtypes[1], '_p_tinyspline__BSpline') && ( is.numeric(argv[[2]]) && length(argv[[2]]) == 1 ) && ( is.numeric(argv[[3]]) && length(argv[[3]]) == 1 )) {
      f <- BSpline_bisect__SWIG_4; 
    }
  } else if (argc == 4) {
    if (extends(argtypes[1], '_p_tinyspline__BSpline') && ( is.numeric(argv[[2]]) && length(argv[[2]]) == 1 ) && ( is.numeric(argv[[3]]) && length(argv[[3]]) == 1 ) && ( is.logical(argv[[4]]) && length(argv[[4]]) == 1 )) {
      f <- BSpline_bisect__SWIG_3; 
    }
  } else if (argc == 5) {
    if (extends(argtypes[1], '_p_tinyspline__BSpline') && ( is.numeric(argv[[2]]) && length(argv[[2]]) == 1 ) && ( is.numeric(argv[[3]]) && length(argv[[3]]) == 1 ) && ( is.logical(argv[[4]]) && length(argv[[4]]) == 1 ) && ( (is.integer(argv[[5]]) || is.numeric(argv[[5]])) && length(argv[[5]]) == 1 )) {
      f <- BSpline_bisect__SWIG_2; 
    }
  } else if (argc == 6) {
    if (extends(argtypes[1], '_p_tinyspline__BSpline') && ( is.numeric(argv[[2]]) && length(argv[[2]]) == 1 ) && ( is.numeric(argv[[3]]) && length(argv[[3]]) == 1 ) && ( is.logical(argv[[4]]) && length(argv[[4]]) == 1 ) && ( (is.integer(argv[[5]]) || is.numeric(argv[[5]])) && length(argv[[5]]) == 1 ) && ( is.logical(argv[[6]]) && length(argv[[6]]) == 1 )) {
      f <- BSpline_bisect__SWIG_1; 
    }
  } else if (argc == 7) {
    if (extends(argtypes[1], '_p_tinyspline__BSpline') && ( is.numeric(argv[[2]]) && length(argv[[2]]) == 1 ) && ( is.numeric(argv[[3]]) && length(argv[[3]]) == 1 ) && ( is.logical(argv[[4]]) && length(argv[[4]]) == 1 ) && ( (is.integer(argv[[5]]) || is.numeric(argv[[5]])) && length(argv[[5]]) == 1 ) && ( is.logical(argv[[6]]) && length(argv[[6]]) == 1 ) && ( (is.integer(argv[[7]]) || is.numeric(argv[[7]])) && length(argv[[7]]) == 1 )) {
      f <- BSpline_bisect__SWIG_0; 
    }
  } else {
    stop("cannot find overloaded function for BSpline_bisect with argtypes (",toString(argtypes),")");
  };
  f(...);
}
...
{
  accessorFuns = list('Functor' = BSpline_Functor, 'controlPointAt' = BSpline_controlPointAt, 'eval' = BSpline_eval, 'bisect' = BSpline_bisect, 'isClosed' = BSpline_isClosed, 'toJSON' = BSpline_toJSON, 'fromJSON' = BSpline_fromJSON, 'save' = BSpline_save, 'load' = BSpline_load, 'setControlPointAt' = BSpline_setControlPointAt, 'insertKnot' = BSpline_insertKnot, 'split' = BSpline_split, 'buckle' = BSpline_buckle, 'toBeziers' = BSpline_toBeziers, 'derive' = BSpline_derive, 'degree' = BSpline_degree_get, 'order' = BSpline_order_get, 'dimension' = BSpline_dimension_get, 'domain' = BSpline_domain_get, 'controlPoints' = BSpline_controlPoints_get, 'knots' = BSpline_knots_get);
